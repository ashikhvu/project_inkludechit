    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chit_duration', models.PositiveIntegerField(blank=True, null=True)),
                ...
                ('auction_date', models.PositiveIntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(27)])),
                ('divident_date', models.PositiveIntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(27)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(blank=True, choices=[('admin', 'admin'), ('super admin', 'super admin'), ('sales agent', 'sales agent'), ('collection agent', 'collection agent'), ('customer', 'customer')], default='customer', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('customer_id', shortuuid.django_fields.ShortUUIDField(alphabet='0123456789', blank=True, length=10, max_length=12, null=True, prefix='', unique=True)),
                ('agent_code', models.CharField(blank=True, max_length=4, null=True, unique=True)),
                ('first_name', models.CharField(blank=True, max_length=255, null=True)),
                ('last_name', models.CharField(blank=True, max_length=255, null=True)),
